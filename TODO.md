...
- [ ] Documentar formato canónico de payload para Jira Automation y GitHub Webhooks con ejemplos copy/paste.
...
- [ ] Agregar guardrails para limitar creación masiva de specs desde spam de comentarios.
